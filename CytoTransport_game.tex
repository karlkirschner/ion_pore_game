...
\begin{tcolorbox}[colback=gray!10,colframe=gray!50!black,title=Game Mechanic: Pore Opening and Closing]
	...
	\textbf{Scientific Reality:} The protein channel's pore can increases and decrease due to structural changes in the protein's subunits (i.e., \textbf{gating}). To approximate this behavior, the proteins are translated horizontally.\\
...
\begin{tcolorbox}[colback=yellow!5,colframe=yellow!50!black,title=Game Mechanic: Ion Size]
	...
	\begin{tabular}{l|c|c|c|l}
		\toprule
		\textbf{Ion} & \textbf{Charge} & \textbf{Radius (\AA)} & \textbf{Color} & \textbf{Context}\\ \midrule
